...
const query1 = client.query(
  'CREATE TABLE highscores(id SERIAL PRIMARY KEY, name VARCHAR(40) not null, score INTEGER not null, date_added TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT NOW());');
